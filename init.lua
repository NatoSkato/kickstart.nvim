...
require('lazy').setup({
  ...
  { -- You can easily change to a different colorscheme.
    ...
    --   vim.cmd.colorscheme 'elflord' --'tokyonight-night'
    -- end,
    config = function()
...
require('luasnip').config.set_config { -- Setting LuaSnip config
  ...
  vim.keymap.set('n', '<Leader>L', '<Cmd>lua require("luasnip.loaders.from_lua").load({paths = "~/.config/nvim/LuaSnip/"})<CR>', { desc = 'reload snippets' }),
}
...
""The next two lines are a fix for jumping being disabled when nvim cmp is for some reason"
